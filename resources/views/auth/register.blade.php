            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row teal" style="justify-content: center; font-weight: bold; font-size: 18px">
                        ...
                        <div class="form-group row col-md-12 teal">
                            ...
                            <div class="row col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="What is your business called?" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row col-md-12 teal">
                            ...
                            <div class="row col-md-12">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="industry" placeholder="What is your business' contact email address?" value="{{ old('email') }}" required autocomplete="email">
